...
1. **Data Preprocessing:** Images are resized to 256x256 pixels and normalized to a [0, 1] range.
2. **Model Training:** The CNN extracts hierarchical features from the images to distinguish between breed characteristics.
3. **Inference:** Users upload an image through the Gradio interface, and the model outputs the most likely breed along with confidence scores.
...
The dataset used for this project is sourced from Kaggle: [Indian Bovine Breeds Dataset](https://www.kaggle.com/datasets/lukex9442/indian-bovine-breeds).
